...
case_name = 'Trial_Full_System_90kW_3hr_Battery_with_Geothermal_Ramp_Limits' # change name!
inputs_file = 'data/test_cases/Trial_Full_System_90kW_3hr_Battery_with_Geothermal_Ramp_Limits/Hybrid.json'
...
dispatch_df = pd.read_csv("data/test_cases/Trial_Full_System_90kW_3hr_Battery_with_Geothermal_Ramp_Limits/dispatch_target_5min.csv")
