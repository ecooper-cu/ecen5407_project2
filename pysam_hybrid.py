...
case_name = 'Trial_Full_System_Bigger_Battery_With_Geothermal_Ramp_Limits' # change name!
...
dispatch_df = pd.read_csv('data/PySam_Inputs/Hybrid_Project/dispatch_target_5min.csv')
